...
namespace policies {
    ...
    private:
        ...
        {
            size_t numElements = haLT::policies::getNumElementsFromExtents(inExtents);
        ...
        {
            size_t numElements = haLT::policies::getNumElementsFromExtents(outExtents);
    ...
    public:
        ...
        {
            using haLT::policies::safe_ptr_cast;
