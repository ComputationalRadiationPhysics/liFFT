...
namespace haLT {
    ...
    template< typename T, class Generator, class T_Accessor = haLT::traits::IdentityAccessor_t<T> >
    void generateData(T& data, const Generator& generator, const T_Accessor& acc = T_Accessor()){
        static constexpr unsigned numDims = haLT::traits::NumDims<T>::value;
        ...
        policies::makeCopy(haLT::traits::IdentityAccessor_t< decltype(genContainer) >(), acc)(genContainer, data);
    }
