...
if(FFTW_ROOT)
    ...
    find_library(FFTW_INCLUDE_DIRS NAMES "fftw3.h" PATHS ${FFTW_ROOT} PATH_SUFFIXES "include")
else()
    find_package(PkgConfig)
    if(PKG_CONFIG_FOUND)
        pkg_check_modules(PKG_FFTW QUIET "fftw3")
        find_library(FFTW_LIB   NAMES "fftw3"  PATHS ${PKG_FFTW_LIBRARY_DIRS})
        find_library(FFTW_F_LIB NAMES "fftw3f" PATHS ${PKG_FFTW_LIBRARY_DIRS})
        find_library(FFTW_L_LIB NAMES "fftw3l" PATHS ${PKG_FFTW_LIBRARY_DIRS})
        find_library(FFTW_INCLUDE_DIRS NAMES "fftw3.h" PATHS ${PKG_FFTW_INCLUDE_DIRS})
    endif()
endif()
